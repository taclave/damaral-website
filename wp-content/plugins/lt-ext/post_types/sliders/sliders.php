...
*/ 
$labels = array(
	'name'               => esc_html__( 'Sliders', 'lt-ext' ),
	'singular_name'      => esc_html__( 'Sliders', 'lt-ext' ),
	'menu_name'          => esc_html__( 'Sliders', 'lt-ext' ),
	'name_admin_bar'     => esc_html__( 'Sliders', 'lt-ext' ),
	'add_new'            => esc_html__( 'Add New', 'lt-ext' ),
	'add_new_item'       => esc_html__( 'Add New Sliders', 'lt-ext' ),
	'new_item'           => esc_html__( 'New Sliders', 'lt-ext' ),
	'edit_item'          => esc_html__( 'Edit Sliders', 'lt-ext' ),
	'view_item'          => esc_html__( 'View Sliders', 'lt-ext' ),
	'all_items'          => esc_html__( 'All Sliders', 'lt-ext' ),
	'search_items'       => esc_html__( 'Search Sliders', 'lt-ext' ),
	'parent_item_colon'  => esc_html__( 'Parent Sliders:', 'lt-ext' ),
