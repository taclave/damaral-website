...
Si tu tema resulta compatible -la función está recién desarrollada y podría no serlo- puedes configurar remplazar otros avisos preexistentes a pie de página por una nota de copyright y enlaces a las páginas legales gestionados por el plugin. Actualmente soporta los temas Twenty Twelve, Twenty Thirteen, Twenty Fourteen, Twenty Fifteen, Twenty Sixteen, Twenty Seventeen, Twenty Nineteen, Twenty Twenty, Twenty Twenty-One y Storefront de WordPress, los temas Flash, ColorMag, eStore, Spacious y Cenote de ThemeGrill, ColorMag, eStore, Spacious y Cenote de ThemeGrill, Envo Shop de EnvoThemes, así como el tema Industro de OceanThemes. Si no funciona en tu tema, [avísanos](https://wordpress.org/support/plugin/proteccion-datos-rgpd) para que veamos si se puede adaptar en una próxima versión o incluirlo en una lista de no compatibles para advertirlo.
...
= 0.60 =
*Sep 12 2022*
* Posibilita la inclusión de código de Analytics para poder gestionar sus cookies si se habilita el banner de cookies.
